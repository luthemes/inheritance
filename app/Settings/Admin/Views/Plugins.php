...
use Inheritance\Settings\Manager\Plugins\Plugins as PluginCollection;
...
class Plugins extends View {
	...
	public function register() {
		...
		// Register plugins.
		add_action( 'inheritance/settings/admin/view/plugins/register', [ $this, 'registerDefaultPlugins' ] );
	}
	...
	public function boot() {
		...
		do_action( 'inheritance/settings/admin/view/plugins/register', $this->plugins );
	}
	...
	public function template() { ?>
		<header>
			<h1><?php esc_html_e( 'Recommended Plugins', 'inheritance' ) ?></h1>
        </header>
        <p>
