...
use Inheritance\Settings\Manager\Themes\Themes as ThemeCollection;
...
class Themes extends View {
	...
	public function register() {
		...
		add_action( 'inheritance/settings/admin/view/themes/register', [ $this, 'registerDefaultThemes' ] );
	}
	...
	public function boot() {
		...
		do_action( 'inheritance/settings/admin/view/themes/register', $this->themes );
	}
