...
namespace Inheritance\Settings\Admin;

use Backdrop\Contracts\Bootable;
use Inheritance\Settings\Admin\Views;
use function Backdrop\Mix\asset;
use Inheritance\Settings\Manager\Themes;
...
class OptionsPage implements Bootable {
	...
	public function admin_styles() {
		wp_enqueue_style( 'Prismatic-admin-styles', asset( 'css/admin.css' ), null, null );
	}
	...
	public function template() { ?>
		...
		<div class="wrap">
			...
			<?php if ( current_user_can( 'customize' ) ) : ?>
				<a href="<?php esc_url( wp_customize_url() ) ?>" class="hide-if-no-js page-title-action"><?php esc_html_e( 'Customize', 'inheritance' ) ?></a>
			<?php endif ?>
