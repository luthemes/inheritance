...
class Component implements Bootable {
	...
	public function registerPanels( WP_Customize_Manager $manager ) {
		$panels = [
				'theme_global'  => esc_html__( 'Theme: Global',  'inheritance' ),
				'theme_header'  => esc_html__( 'Theme: Header',  'inheritance' ),
				'theme_content' => esc_html__( 'Theme: Content', 'inheritance' ),
				'theme_footer'  => esc_html__( 'Theme: Footer',  'inheritance' )
		];
	...
	public function controlsEnqueue() {
		...
		wp_enqueue_script( 'inheritance-customize-controls', asset( 'assets/css/customize-controls.js' ), null, true );
	}
	...
	public function enqueueCustomizerStyles() {
		...
		wp_add_inline_style( 'inheritance-screen', $custom );
	...
	public function enqueueBackgroundStyles() {
		...
		if (!empty($custom_css)) {
			wp_add_inline_style('inheritance-screen', $custom_css);
		}
	}
}