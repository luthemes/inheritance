 ...
 */
 ( function( $ ) {
	...
	screenreadertext.textContent = inheritanceScreenReaderText.expandMain;
	...
	for ( i = 0, len = parentLink.length; i < len; i++ ) {
		...
		screenreadertext.classList.add( 'screen-reader-text' );
		screenreadertext.textContent = inheritanceScreenReaderText.expandChild;
		...
		dropdown.onclick = function() {
			...
			if ( -1 !== parentLink.className.indexOf( 'toggled-on' ) ) {
				...
				screenreadertext.textContent = inheritanceScreenReaderText.collapseChild;
			}
		};
	}
	...
	button.onclick = function() {
		...
		if ( -1 !== container.className.indexOf( 'toggled' ) ) {
			...
			screenreadertext.textContent = inheritanceScreenReaderText.collapseMain;
